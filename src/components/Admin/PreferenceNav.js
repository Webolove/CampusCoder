...
export default function PreferenceNav({ formType, setFormType }) {
            ...
            <div className='relative full'>
                <div className='flex place-items-center justify-between'>
                    ...
                    <button
                        ...
                        className='flex cursor-pointer items-center rounded px-3 py-1.5 text-left focus:outline-none whitespace-nowrap bg-white hover:bg-[#ebe6e6] active:[#e6e6eb] w-[170px] justify-between'
                        type='button'
                    >
                        {formType}
                        <BsChevronDown />
                ...
                {dropDownOpen && (
                    <ul
                        className='absolute mt-1 max-h-56 overflow-auto rounded-lg p-2 z-50 focus:outline-none shadow-lg   w-full bg-[#f0f0f5]'
                        style={{
