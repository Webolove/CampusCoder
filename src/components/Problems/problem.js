...
export default function problem() {
    ...
    return (
        <section className='h-full w-full max-w-[1300px] mx-auto'>
            <div className='overflow-x-auto relative grid grid-rows-4 grid-flow-col gap-4 px-6 pb-10'>
                {/* Grid 1 */}
